    ...
    if (interaction.commandName === 'createrole') {
        ...
        const rolePresets = {
            ...
            moderator: {
                ...
                color: '#00FF00',
                permissions: [
                    PermissionFlagBits.ViewAuditLog,
                    ...
                    PermissionFlagBits.MuteMembers,
                    PermissionFlagBits.DeafenMembers,
                    PermissionFlagBits.MoveMembers,
                    PermissionFlagBits.ViewChannel,
                    PermissionFlagBits.SendMessages,
                    PermissionFlagBits.SendMessagesInThreads,
                    PermissionFlagBits.CreatePublicThreads,
                    PermissionFlagBits.CreatePrivateThreads,
                    PermissionFlagBits.EmbedLinks,
                    PermissionFlagBits.AttachFiles,
                    PermissionFlagBits.AddReactions,
                    PermissionFlagBits.UseExternalEmojis,
                    PermissionFlagBits.UseExternalStickers,
                    PermissionFlagBits.MentionEveryone,
                    PermissionFlagBits.ReadMessageHistory,
                    PermissionFlagBits.UseApplicationCommands,
                    PermissionFlagBits.Connect,
                    PermissionFlagBits.Speak,
                    PermissionFlagBits.Stream,
                    PermissionFlagBits.UseVAD,
                    PermissionFlagBits.PrioritySpeaker,
                    PermissionFlagBits.RequestToSpeak
                ],
            ...
            vip: {
                ...
                permissions: [
                    ...
                    PermissionFlagBits.CreatePublicThreads,
                    PermissionFlagBits.CreatePrivateThreads,
                    PermissionFlagBits.SendVoiceMessages,
                    PermissionFlagBits.EmbedLinks,
                    PermissionFlagBits.AttachFiles,
                    PermissionFlagBits.AddReactions,
                    PermissionFlagBits.UseExternalEmojis,
                    ...
                    PermissionFlagBits.PrioritySpeaker,
                    PermissionFlagBits.RequestToSpeak,
                    PermissionFlagBits.UseSoundboard,
                    PermissionFlagBits.UseEmbeddedActivities,
                    PermissionFlagBits.ChangeNickname,
                    PermissionFlagBits.CreateInstantInvite,
                    PermissionFlagBits.ManageNicknames,
                    PermissionFlagBits.ManageThreads,
                    PermissionFlagBits.ManageMessages,
                    PermissionFlagBits.ViewGuildInsights
                ],
